...
$sql = "insert into genpatient values(DEFAULT, '$addRoomNo', '$addName', '$addAge', '$addSex', '$addPhone','$addAddress','$addDate','$addproblem')";
$result = mysqli_query($conn, $sql);
echo "<script>alert('General Patient Details Added!!');</script>";
