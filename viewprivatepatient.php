...
?>
	<center><h1 style="padding: 8px 16px; background-color: #322dbc;color: white;">Private Patient Details</h1></center> 
<?php
...
$conn = mysqli_connect($dbservername, $dbusername, $dbpassword, $dbname);
  ...
  $tot=0;
  $sql = "CALL getPrivatePatients();";
  $result = mysqli_query($conn, $sql);
   echo "<br><form class='form1' style='text-align:center;' action='removePpatient.php' method='get'><table><tr><th>Patient ID</th><th>Patient Room NO.</th><th>Patient Name</th><th>Patient Age</th><th>Gender</th><th>Phone</th><th>Address</th><th>Problem Description</th><th>Admitted Date</th><th></th></tr>";
